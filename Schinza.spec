...
hiddenimports = ['ssl', '_ssl', 'pyperclip', 'requests', 'app.mitm_addon', 'app.history_client', 'app.history_export', 'app.article_reader', 'app.sightings', 'app.history_ranges', 'app.history_account_select', 'app.capture_target', 'app.updater', 'bs4', 'lxml', 'docx']
